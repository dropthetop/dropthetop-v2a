...
- **Sitemap generation**
  ...
  - Category: Oversight  - Disposition: FIX-BEFORE-DONE
## Analytics
...
- **GA4 event tracking**
  ...
  - Category: Re-implement  - Disposition: FIX-BEFORE-DONE
- **Anonymous session + fingerprint analytics**
  ...
  - Category: Re-implement  - Disposition: DEFER-POST-LAUNCH
## Dashboard
...
- **Scroll & state restoration (site-wide)**
  ...
  - Category: Stack-specific  - Disposition: FIX-BEFORE-DONE
---
